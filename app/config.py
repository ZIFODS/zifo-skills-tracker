...
# Request session
if PROD_ENV:
    SESSION_SECRET = get_secret(AWS_SECRET_NAME_API, AWS_REGION)
...
if PROD_ENV:
    JWT_SECRET_KEY = get_secret(AWS_SECRET_NAME_API, AWS_REGION)
...
# neo4j
if PROD_ENV:
    NEO4J_SECRET = get_secret(AWS_SECRET_NAME_NEO4J, AWS_REGION)
    NEO4J_URI = NEO4J_SECRET["uri"]
    NEO4J_USER = NEO4J_SECRET["username"]
...
# Azure AD
if PROD_ENV:
    AZURE_SECRET = get_secret(AWS_SECRET_NAME_AZURE, AWS_REGION)
