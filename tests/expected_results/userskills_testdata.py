...
class UserSkillsGetAll:
    QUERY_PATH = f"/user/skills/"  # no input required
    EXPECTED_OUTPUT = {'items': [{'name': 'C++', 'category': 'Programming_languages', 'type': 'Skill'},
                                 ...
                                 {'name': 'Mbook ELN', 'category': 'Scientific_Products_And_Applications',
                                  'type': 'Skill'},
                                 {'name': 'SciNote ELN', 'category': 'Scientific_Products_And_Applications',
                                  'type': 'Skill'},
                                 {'name': 'BIOVIA Pipeline Pilot', 'category': 'Scientific_Products_And_Applications',
                                  'type': 'Skill'},
                                 {'name': 'Hamilton', 'category': 'Scientific_Products_And_Applications',
                                  'type': 'Skill'}, {'name': 'Nexus', 'category': 'Methodology', 'type': 'Skill'},
                                 ...
                                 {'name': 'Cloud Archecture,Migration & Integration', 'category': 'Service',
                                  'type': 'Skill'},
...
class UserSkillsGetLearnedSkill:
    ...
    EXPECTED_OUTPUT = {"name": "C++", "category": "Programming_languages", "type": "Skill"}
...
class UserSkillsTrainTrainedSkill:
    ...
    EXPECTED_DETAIL = f"The following skills are already linked to the user: {INPUT[0]['name']}"
...
class UserSkillsTrainSkills:
    QUERY_PATH = "/user/skills/"  # POST request - no parameters in URL
    INPUT = [{"name": "CDISC Study Data Tabulation Model", "category": "Data_Management"}, {"name": "Dutch",
                                                                                            "category": "Languages"}]
    # input: POST request body, list with multiple skill dicts not linked to test user
    EXPECTED_OUTPUT = {
        "items": [{"name": "CDISC Study Data Tabulation Model", "category": "Data_Management", "type": "Skill"},
...
class UserSkillsForgetSkills:
    ...
    EXPECTED_MESSAGE = f"Removed {INPUT1}, {INPUT2} " \
